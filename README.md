...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/coverage-badge-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10136&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/coverage-badge-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `coverage-badge` can be installed with:

```
conda install coverage-badge
```

It is possible to list all of the versions of `coverage-badge` available on your platform with:
